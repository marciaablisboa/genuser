...
require 'phpmailer/class.smtp.php';
    ...
    if($_POST)
    {
        ...
        if (empty($erros)) {
            ...
            $mail->SMTPsecure= 'tls';
            $mail->From = 'marciabarbosa.tj@gmail';
...
<html>
	...
	<body>
		...
		<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" id="contato">
			<fieldset>
				<legend>Formulário de Contato</legend><br>
